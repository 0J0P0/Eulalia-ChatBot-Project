...
python EulaliaGPT/macsql_files/run.py \
   --input_file "EulaliaGPT/macsql_files/input_automated.json" \
   --db_path "" \
   --output_file "EulaliaGPT/macsql_files/output_eulaliadb_automated.json" \
   --log_file "EulaliaGPT/macsql_files/log.txt" \
   --tables_json_path "EulaliaGPT/macsql_files/tables_data.json"
